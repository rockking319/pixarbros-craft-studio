      ...
      <AnimatePresence>
        {!open && (
          ...
          >
            ...
            <span className="relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-[#7C3AED] to-[#06B6D4] shadow-[0_10px_40px_-5px_rgba(124,58,237,0.6)] ring-1 ring-white/20 p-3">
              <img src={pixarbrosLogo} alt="Pixarbros" className="w-full h-full object-contain brightness-0 invert drop-shadow" />
            </span>
          </motion.button>
        )}
      </AnimatePresence>
